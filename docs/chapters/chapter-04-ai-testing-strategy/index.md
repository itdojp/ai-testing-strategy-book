...
従来のテストピラミッドは、単体テストを基盤とし、統合テスト、UIテストと上位に行くほど数を減らす構造である。この考え方は、人間が書くコードには有効だったが、AI生成コードには適さない。理由は次のとおりである。
...
本章では、AI主導開発に適応した新しいテスト戦略を探求した。主要な学びは以下のとおりである。
...
- [ ] テスト戦略をドキュメント化できる（テンプレは [付録A テンプレート集](../../appendices/appendix-a-templates/) を参照）。
