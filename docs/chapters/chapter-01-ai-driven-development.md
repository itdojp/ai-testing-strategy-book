...
2024年時点で、主要なAI支援開発ツールの導入率は急速に上昇している。2024年時点の一般的な開発者調査によれば、プロフェッショナル開発者の 70%以上が何らかのAIツールを日常的に使用していると報告されている（参考: [Stack Overflow Developer Survey 2024](https://survey.stackoverflow.co/2024/)）。ただし、組織・プロジェクトによって実態は異なる点に留意が必要である。

主要なAIツールとその用途（執筆時点の例）：
...
> **注記**  
> 数値はツール/タスク/チームの熟練度/導入方法に強く依存する。本書では、数値そのものより「速度向上が品質課題を増幅する」点に注目する。
...
> **前提**: 本書全体で扱うAI支援ツールは、いかに高度になっても品質保証の責任主体そのものではなく、あくまで開発・テストプロセスを支援するための道具である。最終的な品質基準の定義と適用、検証結果の判断、リリース可否の決定といった責任は、人間（開発チームおよび組織）が負う。以降は、この前提のもとで議論を進める。
...
- AI支援ツールの普及により、開発プロセスやエンジニアの役割が「人間中心」から「人間とAIの協調」へとシフトしつつあることを整理した。
...
- 本章で整理した「現状と課題」を具体的なテスト計画に落とし込む際は、[付録A テンプレート集](../appendices/appendix-a-templates.html) のテスト計画書テンプレートを参照するとよい。
- 自組織の AI 利用状況やリスクを棚卸しする際は、[付録B チェックリスト](../appendices/appendix-b-checklists.html) をベースに、独自の観点を追加することを検討してほしい。
