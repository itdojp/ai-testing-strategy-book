...
- ケーススタディを自組織で再現・応用する際は、[付録A テンプレート集](../appendices/appendix-a-templates/) のテスト計画書やリスク分析のフォーマットをベースに、自分たち向けの計画を作成するとよい。
- ケースの振り返りやポストモーテムを行う際には、[付録B チェックリスト](../appendices/appendix-b-checklists/) を利用し、学びの抜け漏れを防ぐことを推奨する。
