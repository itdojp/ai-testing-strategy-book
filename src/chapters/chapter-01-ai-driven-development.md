...
2024年時点で、主要なAI支援開発ツールの導入率は急速に上昇している。Stack Overflow Developer Survey 2024^[1](#ref-1)など、2024年時点の一般的な開発者調査によれば、プロフェッショナル開発者の70%以上が何らかのAIツールを日常的に使用していると報告されている。ただし、組織・プロジェクトによって実態は異なる点に留意が必要である。
